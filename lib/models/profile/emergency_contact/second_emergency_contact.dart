...
//<editor-fold desc="Data Methods">
  ...
  bool operator ==(Object other) =>
      ...
      (other is SecondEmergencyContact &&
  ...
  SecondEmergencyContact copyWith({
    String? name,
    String? relation,
  ...
  factory SecondEmergencyContact.fromMap(Map<String, dynamic> map) {
    return SecondEmergencyContact(
      name: map['name'] ?? '',
